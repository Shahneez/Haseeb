...
function showDetails(){
    ...
    text (topRefugeesTable.getNum(selectedRow, 'Total'), 600, 150);
    text (topRefugeesTable.getNum(selectedRow, 'Asylum-seekers'), 600, 170);
}
}
...
function mousePressed(){
    ...
    if (mouseX > 210 && mouseX < 285 && mouseY > 30 && mouseY < 50){
        selectedButton = 2;
    }    
    if (mouseX > 290 && mouseX < 365 && mouseY > 30 && mouseY < 50){
        selectedButton = 3;
    }    
    if (mouseX > 370 && mouseX < 445 && mouseY > 30 && mouseY < 50){
        selectedButton = 4;
    }    
    if (mouseX > 450 && mouseX < 525 && mouseY > 30 && mouseY < 50){
        selectedButton = 5;
    }   
    if (mouseX > 530 && mouseX < 605 && mouseY > 30 && mouseY < 50){
        selectedButton = 6;
    }   
    if (mouseX > 610 && mouseX < 685 && mouseY > 30 && mouseY < 50){
        selectedButton = 7;
    }  
    if (mouseX > 690 && mouseX < 765 && mouseY > 30 && mouseY < 50){
        selectedButton = 8;
    }    
}
